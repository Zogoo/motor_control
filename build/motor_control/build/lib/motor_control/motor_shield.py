...
# -*- coding: utf-8 -*-
"""
   MotorShield class - Python class for controlling Arduino Motor Shield L293D from Raspberry Pi
...
class MotorShield:
    ...
    def __init__(self, use_board=False):
        """
        Initialize function for MotorShield class
    ...
    def set_pwm_frequency(self, motors_freq):
        ...
        Example: {MotorShield.DC_Motor_1: 50, MotorShield.DC_Motor_2: 50, MotorShield.DC_Motor_3: 50, MotorShield.DC_Motor_4: 50}
