from motor_control.motor_shield import MotorShield
import time

class Controller:
    LEFT_CHAIN_MOTOR = MotorShield.DC_Motor_1
    RIGHT_CHAIN_MOTOR = MotorShield.DC_Motor_2
    BODY_MOTOR = MotorShield.DC_Motor_3
    SHOVEL_MOTOR = MotorShield.DC_Motor_4

    def __init__(self):
        self.motors = MotorShield()
